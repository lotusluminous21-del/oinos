...
export function generateSolution(state: KnowledgeState): Solution {
  ...
  if ((depth as string) === 'surface') {
    steps.push({
      ...
      products: [
        {
          ...PRODUCT_CATALOG.degreaser,
          productId: PRODUCT_CATALOG.degreaser.id,
          productSlug: PRODUCT_CATALOG.degreaser.slug,
          isEssential: true,
          quantity: 1,
        },
      ],
    ...
    steps.push({
      ...
      products: [
        {
          ...PRODUCT_CATALOG.scratchRemover,
          productId: PRODUCT_CATALOG.scratchRemover.id,
          productSlug: PRODUCT_CATALOG.scratchRemover.slug,
          isEssential: true,
          quantity: 1,
        },
      ],
    ...
    return {
      ...
      basedOn: {
        ...
        damageDepth: 'Surface marks only',
        material,
        colorType,
        size,
        rustPresent: false,
  ...
  steps.push({
    ...
    products: [
      ...
      {
        ...PRODUCT_CATALOG.tackCloth,
        productId: PRODUCT_CATALOG.tackCloth.id,
        productSlug: PRODUCT_CATALOG.tackCloth.slug,
        isEssential: true,
        quantity: 1,
      },
    ],
  ...
  if (rustPresent) {
    steps.push({
      ...
      products: [
        {
          ...PRODUCT_CATALOG.sandpaper320,
          productId: PRODUCT_CATALOG.sandpaper320.id,
          productSlug: PRODUCT_CATALOG.sandpaper320.slug,
          isEssential: true,
          quantity: 1,
          reason: 'For removing loose rust and feathering edges',
        },
        {
          ...PRODUCT_CATALOG.rustConverter,
          productId: PRODUCT_CATALOG.rustConverter.id,
          productSlug: PRODUCT_CATALOG.rustConverter.slug,
          isEssential: true,
          quantity: 1,
        },
      ],
  ...
  steps.push({
    ...
    products: rustPresent ? [
      {
        ...PRODUCT_CATALOG.sandpaper600,
        productId: PRODUCT_CATALOG.sandpaper600.id,
        productSlug: PRODUCT_CATALOG.sandpaper600.slug,
        isEssential: true,
        quantity: 1,
      },
    ] : [
  ...
  steps.push({
    ...
    products: [
      {
        ...PRODUCT_CATALOG.maskingTape,
        productId: PRODUCT_CATALOG.maskingTape.id,
        productSlug: PRODUCT_CATALOG.maskingTape.slug,
        isEssential: true,
        quantity: 1,
      },
      {
        ...PRODUCT_CATALOG.maskingPaper,
        productId: PRODUCT_CATALOG.maskingPaper.id,
        productSlug: PRODUCT_CATALOG.maskingPaper.slug,
        isEssential: false,
        quantity: 1,
      },
    ],
  ...
  const primerProducts = material === 'plastic' ? [
    {
      ...PRODUCT_CATALOG.plasticPrimer,
      productId: PRODUCT_CATALOG.plasticPrimer.id,
      productSlug: PRODUCT_CATALOG.plasticPrimer.slug,
      isEssential: true,
      quantity: 1,
      reason: 'Essential for paint adhesion on plastic surfaces',
    },
    {
      ...PRODUCT_CATALOG.universalPrimer,
      productId: PRODUCT_CATALOG.universalPrimer.id,
      productSlug: PRODUCT_CATALOG.universalPrimer.slug,
      isEssential: true,
      quantity: 1,
      reason: 'Applied over adhesion promoter for best results',
    },
  ] : [
    {
      ...primerProduct,
      productId: primerProduct.id,
      productSlug: primerProduct.slug,
      isEssential: true,
      quantity: 1,
    },
  ];
    ...
    products: [
      {
        ...
        productSlug: baseCoat.slug,
        isEssential: true,
        quantity: size === 'large' ? 2 : 1,
      },
    ],
  });
  ...
  steps.push({
    ...
    products: [
      {
        ...PRODUCT_CATALOG.clearCoat2K,
        productId: PRODUCT_CATALOG.clearCoat2K.id,
        productSlug: PRODUCT_CATALOG.clearCoat2K.slug,
        isEssential: true,
        quantity: size === 'large' ? 2 : 1,
      },
    ],
  ...
  steps.push({
    ...
    products: [
      {
        ...PRODUCT_CATALOG.sandpaper1500,
        productId: PRODUCT_CATALOG.sandpaper1500.id,
        productSlug: PRODUCT_CATALOG.sandpaper1500.slug,
        isEssential: false,
        quantity: 1,
      },
      {
        ...PRODUCT_CATALOG.sandpaper2000,
        productId: PRODUCT_CATALOG.sandpaper2000.id,
        productSlug: PRODUCT_CATALOG.sandpaper2000.slug,
        isEssential: false,
        quantity: 1,
      },
      {
        ...PRODUCT_CATALOG.cuttingCompound,
        productId: PRODUCT_CATALOG.cuttingCompound.id,
        productSlug: PRODUCT_CATALOG.cuttingCompound.slug,
        isEssential: true,
        quantity: 1,
      },
      {
        ...PRODUCT_CATALOG.polishingCompound,
        productId: PRODUCT_CATALOG.polishingCompound.id,
        productSlug: PRODUCT_CATALOG.polishingCompound.slug,
        isEssential: true,
        quantity: 1,
      },
    ],
  ...
  const rustTime = rustPresent ? 60 : 0; // plus 24hr cure
