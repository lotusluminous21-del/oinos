...
const QUESTIONS: Record<string, Question> = {
  damageDepth: {
    ...
    required: true,
    options: [
      { id: 'surface', label: 'Surface marks only', description: 'Light scratches you can barely feel', icon: '🟢', value: 'surface' },
      { id: 'throughClear', label: 'Through the clear coat', description: 'Different color visible beneath', icon: '🟡', value: 'throughClear' },
      { id: 'toMetal', label: 'Down to bare metal', description: 'Shiny metal or rust visible', icon: '🔴', value: 'toMetal' },
    ],
  },
  material: {
    id: 'material',
    ...
    required: true,
    options: [
      { id: 'metal', label: 'Metal', description: 'Door, fender, hood, trunk', icon: '🚗', value: 'metal' },
      { id: 'plastic', label: 'Plastic', description: 'Bumper, mirror housing, trim', icon: '🛡️', value: 'plastic' },
    ],
  },
  colorType: {
    id: 'colorType',
    ...
    required: false,
    options: [
      { id: 'solid', label: 'Solid / Flat', description: 'No sparkle or shimmer', icon: '⬜', value: 'solid' },
      { id: 'metallic', label: 'Metallic', description: 'Has sparkle/flakes in the paint', icon: '✨', value: 'metallic' },
      { id: 'pearl', label: 'Pearl / Mica', description: 'Color seems to shift at angles', icon: '🌈', value: 'pearl' },
    ],
  },
  rustPresent: {
    id: 'rustPresent',
    ...
    required: false,
    options: [
      { id: 'yes', label: 'Yes, rust visible', description: 'Orange/brown color in or around damage', icon: '🟠', value: true },
      { id: 'no', label: 'No rust', description: 'Clean metal or paint only', icon: '✅', value: false },
    ],
  },
  size: {
    id: 'size',
    ...
    required: false,
    options: [
      { id: 'tiny', label: 'Tiny (< 1cm)', description: 'Dot or small chip', value: 'tiny' },
      { id: 'small', label: 'Small (1-5cm)', description: 'Fingertip to palm-width', value: 'small' },
      { id: 'medium', label: 'Medium (5-15cm)', description: 'Palm-sized or larger', value: 'medium' },
      { id: 'large', label: 'Large (15cm+)', description: 'Major area or panel', value: 'large' },
    ],
  },
  colorDescription: {
    id: 'colorDescription',
  ...
  equipment: {
    ...
    required: false,
    options: [
      { id: 'aerosol', label: 'None / Spray cans', description: 'I\'ll use aerosol products', icon: '🎨', value: 'aerosol' },
      { id: 'sprayGun', label: 'Spray gun & compressor', description: 'I have painting equipment', icon: '🔧', value: 'sprayGun' },
    ],
  },
};
...
function formatValue(field: string, value: any): string {
  ...
  const valueLabels: Record<string, Record<string, string>> = {
    ...
    damageDepth: { surface: 'Surface marks only', throughClear: 'Through clear coat', toPrimer: 'Down to primer', toMetal: 'Down to bare metal' },
    material: { metal: 'Metal panel', plastic: 'Plastic', fiberglass: 'Fiberglass', mixed: 'Mixed materials' },
    colorType: { solid: 'Solid', metallic: 'Metallic', pearl: 'Pearl/Mica', tricoat: 'Tri-coat' },
    size: { tiny: 'Tiny (<1cm)', small: 'Small (1-5cm)', medium: 'Medium (5-15cm)', large: 'Large (15cm+)' },
