  ...
  return (
    <div className="min-h-screen bg-skeuo-bg">
      <header className="fixed top-0 left-0 right-0 z-50 h-[60px] px-4 bg-skeuo-bg shadow-[0_4px_12px_rgba(0,0,0,0.03)] flex items-center">
        ...
        <h1 className="flex-1 text-center text-[18px] font-bold text-slate-900">Order History</h1>
        <div className="w-10" />
      </header>
      <main className="pt-[100px] pb-[100px] px-4 text-center">
        <Clock className="w-16 h-16 text-slate-300 mx-auto mb-4" />
        <h2 className="text-[18px] font-bold text-slate-800 mb-2">No Orders Yet</h2>
        <p className="text-[14px] text-slate-500">Your order history will appear here</p>
      </main>
      <BottomNav />
    </div>
  );
