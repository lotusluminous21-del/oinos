    ...
    >
      ...
      <div
        className={cn(
          ...
          "group-data-[state=open]/item:bg-skeuo-bg group-data-[state=open]/item:shadow-[inset_2px_2px_4px_rgba(0,0,0,0.08),inset_-2px_-2px_4px_rgba(255,255,255,0.8)]",
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    <div
      className={cn(
        "pb-[20px] pt-1 px-[24px] group-data-[state=open]/item:px-[20px]",
        className
      )}
    >
      {children}
