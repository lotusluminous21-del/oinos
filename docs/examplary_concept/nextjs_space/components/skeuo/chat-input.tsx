...
import { Send, Camera, Mic, X, Image as ImageIcon } from "lucide-react"
      ...
      {!message && !imagePreview && !disabled && (
        <div className="flex flex-wrap gap-2 mt-3">
          <button
            ...
            className="text-[13px] px-4 py-2 rounded-full bg-skeuo-bg shadow-skeuo-raised text-slate-600 font-semibold hover:shadow-skeuo-raised-hover transition-all"
          >
            📍 Fix a scratch
          </button>
          <button
