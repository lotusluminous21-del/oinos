...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Item
    ref={ref}
    className={cn(
      "group/item rounded-[24px] bg-skeuo-bg transition-all duration-300 border-none",
      "shadow-skeuo-raised",
  ...
  >
    <div className={cn(
      ...
      "group-data-[state=open]/item:rounded-[20px] group-data-[state=open]/item:shadow-skeuo-inset",
  ...
  <AccordionPrimitive.Header className="flex">
    ...
    >
      ...
      <div className={cn(
        ...
        "group-data-[state=open]/item:bg-skeuo-bg group-data-[state=open]/item:shadow-skeuo-inset",
...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Content
    ...
    {...props}
  >
    <div className={cn("pb-[20px] pt-1 px-[24px] group-data-[state=open]/item:px-[20px]", className)}>
      {children}
    </div>
  </AccordionPrimitive.Content>
))
