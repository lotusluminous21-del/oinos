...
export function ProductGallery({ className, ...props }: ProductGalleryProps) {
    const [activeIndex, setActiveIndex] = React.useState(0);

    return (
        <div className={cn("flex flex-col items-center w-full", className)} {...props}>
            <div className={cn(
                "w-full aspect-[4/3.5] rounded-[32px] bg-[#F0F2F6]",
                ...
                {/* Mock image placeholder mirroring the premium clear coat can */}
