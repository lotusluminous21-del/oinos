...
"""
    ...
    def generate_studio(doc_ref, data: dict):
        ...
        IMAGEN_PROMPTS = {
            "clean": f"Professional studio product photography. The product is center-framed. **Background**: Absolutely flat, solid, non-reflective chroma key green (#00FF00) covering the entire frame. **No floor, no shadows, no reflections, and no horizon dots.** The product appears to be perfectly isolated against a uniform green void. {sizing_instruction}",
            ...
            "styled": f"High-end commercial photography. The product is surrounded by a {decorative_effect}. {color_instruction} {sizing_instruction} **Background**: Solid, uniform, flat chroma key green (#00FF00) screen with **zero reflections, zero shadows, and no visible floor/wall junction.** The product and effects reside in a perfectly flat green studio space. Lighting: Environment-driven tech-premium setup, ensuring the green background remains a solid un-lit color."
        }
